...
class CustomPostTypeController extends BaseController
{
	...
	{
		if ( ! $this->activated( 'store_page' ) ) return;
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'stanislav_plugin_cpt_settings',
				'option_name' => 'stanislav_plugin_cpt',
